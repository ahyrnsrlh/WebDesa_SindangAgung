  ...
  <div class="container">
    <a class="navbar-brand d-flex">
      <?php
            ...
            ?>
            <img src="web/asset/gambar/<?php echo $a['logo_desa'] ?>" width="45" height="38" class="d-md-block d-lg-block">
    ...
    <div class="navbar-toggler"  id="nav-to" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown">
      <span id="span1"></span>
      <span id="span2"></span>
      <span id="span3"></span>
    </div>
